...
//search element in the tree so that it is inside the tree or not-->
...
int main()
{
    ...
    printf("\nenter the element you want to search in the tree ");
    scanf("%d",&search);
    struct tree*s = searchtree(t1,search);

    //element found algorithm-->
    if (s!=NULL)
    {
