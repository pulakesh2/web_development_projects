...
//  create a function which returns internal nodes of the tree-->
int internal_nodes(struct tree*root){
    if (root == NULL)
    {
        return 0;
    }
...
// create a function which returns external nodes of the tree-->
int external_nodes(struct tree*root){
    if (root == NULL)
    {
        return 0;
    }
...
int main()
{
    ...
    // print the internal node of the tree-->
    printf("\ninternal node of the tree is %d",internal_nodes(t1));

    // print the internal node of the tree-->
    printf("\nexternal node of the tree is %d",external_nodes(t1));
    return 0;
}